...
for (const l of lines) { const h = normalizeHeader(l.rawText); if (h.includes('JER') || h.includes('D E') || h.includes('J U')) console.log(l.page, l.column, JSON.stringify(l.rawText), '=>', JSON.stringify(h), parseMeetingHeader(l.rawText, year)); }